    ...
    return (
        <div className='flex flex-col items-center gap-8 py-24 px-4' id='speciality'>
            ...
            <motion.div 
                ...
                className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 w-full max-w-7xl mt-8'
            >
                {specialityData.map((item, index) => (
                    ...
                    >
                        <Link 
                            ...
                            className='group flex flex-col items-center p-8 rounded-[2rem] bg-white border border-gray-100 hover:border-primary/20 hover:bg-primary/5 transition-all duration-500 shadow-sm hover:shadow-xl' 
